      ...
      phases: [
        {
          ...
          verification: {
            ...
            derivedPosture: "INSUFFICIENT",
            unknownDisputedPosture: "CONTESTED",
            tracePosture: "UNVERIFIED",
            artifactReadiness: "not_ready",
            note: "Early scene is largely recorded; derived context is still forming.",
            noteTr: "Erken sahne büyük ölçüde kayıtlı; türetilmiş bağlam henüz netleşmiyor.",
          },
        },
        {
          phase: "t1",
          ...
          verification: {
            posture: "CONTESTED",
            recordedPosture: "SUPPORTED",
            derivedPosture: "CONTESTED",
            unknownDisputedPosture: "CONTESTED",
            tracePosture: "SUPPORTED",
            artifactReadiness: "limited",
            note: "Approach phase has mixed context; core evidence supports sequencing, while interpretation remains contested.",
            noteTr: "Yaklaşım aşaması karışık bağlama sahip; çekirdek kanıt sıralamayı destekler, yorumlama ise çekişmeli kalır.",
          },
        },
        {
          phase: "t2",
          ...
          verification: {
            ...
            unknownDisputedPosture: "CONTESTED",
            tracePosture: "SUPPORTED",
            artifactReadiness: "bounded",
            note: "Critical phase is strongly evidenced with recorded telemetry and trace; uncertain interpretive edges still remain.",
            noteTr: "Kritik aşama, kayıtlı telemetri ve izle güçlü şekilde destekleniyor; belirsiz yorum özellikleri hâlâ mevcut.",
          },
        },
        {
          phase: "t3",
          ...
          verification: {
            ...
            tracePosture: "UNVERIFIED",
            artifactReadiness: "limited",
            note: "Post-event closure documents state, but unresolved questions keep definitive conclusions out of scope.",
            noteTr: "Olay sonrası kapanış belgeleri mevcut, ancak çözülmemiş sorular kesin sonuçları kapsam dışı bırakıyor.",
          },
        },
      ],
    },
      ...
      phases: [
        {
          ...
          verification: {
            ...
            tracePosture: "UNVERIFIED",
            artifactReadiness: "not_ready",
            note: "Drone pre-event health is mostly recorded; decision posture not established until link events complete.",
            noteTr: "Drone ön olayı büyük ölçüde kayıtlı; bağlantı olayı tamamlanana kadar karar duruşu belirlenmedi.",
          },
        },
        {
          phase: "t1",
          ...
          verification: {
            ...
            tracePosture: "SUPPORTED",
            artifactReadiness: "limited",
            note: "Approach tracking is solid, but the threshold for failover is still contested.",
            noteTr: "Yaklaşım takibi sağlam, ancak devre geçirme eşiği hâlâ çekişmeli.",
          },
        },
        {
          phase: "t2",
          ...
          verification: {
            ...
            tracePosture: "SUPPORTED",
            artifactReadiness: "bounded",
            note: "Actual loss and handoff are documented; situational uncertainty remains in escalation boundaries.",
            noteTr: "Asıl bağlantı kaybı ve el değişimi belgelenmiş; durum belirsizliği eskalasyon sınırlarında devam ediyor.",
          },
        },
        {
          phase: "t3",
          ...
          verification: {
            ...
            tracePosture: "UNVERIFIED",
            artifactReadiness: "limited",
            note: "Post-event reconciliation is underway; unresolved dispute points keep issuance bounded.",
            noteTr: "Olay sonrası uzlaştırma sürüyor; çözülmemiş ihtilaf noktaları düzenlemeyi sınırlıyor.",
          },
        },
      ],
    },
      ...
      phases: [
        {
          ...
          verification: {
            ...
            tracePosture: "UNVERIFIED",
            artifactReadiness: "not_ready",
            note: "Baseline node is anchored in recorded data; assumption fields are not yet resolved.",
            noteTr: "Temel düğüm kayıtlı veriye bağlandı; varsayım alanları henüz çözülmedi.",
          },
        },
        {
          phase: "t1",
          ...
          verification: {
            ...
            tracePosture: "SUPPORTED",
            artifactReadiness: "limited",
            note: "Approach margins are detected, but handoff intent remains under question.",
            noteTr: "Yaklaşım marjları tespit edildi, ancak el değişimi niyeti tartışmalı kalmaya devam ediyor.",
          },
        },
        {
          phase: "t2",
          ...
          verification: {
            ...
            tracePosture: "SUPPORTED",
            artifactReadiness: "bounded",
            note: "Critical intervention is documented; remaining doubt is in force assignment, not event flow.",
            noteTr: "Kritik müdahale belgelenmiş; kalan şüphe kuvvet atamasında, olay akışında değil.",
          },
        },
        {
          phase: "t3",
          ...
          verification: {
            ...
            tracePosture: "UNVERIFIED",
            artifactReadiness: "limited",
            note: "Finalization is observed but open items keep artifact issuance conditional.",
            noteTr: "Bitirme gözlemlendi fakat açık kalan hususlar belge düzenlemesini koşullu tutuyor.",
          },
        },
      ],
    },

...
const en = {
  ...
  verifierWaitingSelectionBody:
    "This inspection surface does not populate until you bind a canonical event package via the command spine: source, device family, incident class, then event package. One package at a time—this is not a dashboard rollup.",
  ...
  accessBack: "Back",
  accessNote:
    "This surface is intentionally bounded. Access is granted only through authorized institutional scope.",
  ...
  docFamily_passWitnessSummary: "PASS Witness Summary",
  docFamily_passVerificationSummary: "PASS Verification Summary",
  docFamily_passIncidentReviewSummary: "PASS Incident Review Summary",
  docFamily_passLimitationAnnex: "PASS Limitation Annex",
  docFamily_passVehicleIncidentReport: "PASS Vehicle Incident Report",
  docFamily_integrityFailureNotice: "Integrity Failure Notice",
  docFamily_tamperDetectedNotice: "Tamper Detected Notice",
  docFamily_chainBreachNotice: "Chain Breach Notice",
  docFamily_artifactInvalidityNotice: "Artifact Invalidity Notice",
...
const tr = {
  ...
  verifierWaitingSelectionBody:
    "Bu inceleme yüzeyi, komut omurgasında kaynak → cihaz ailesi → olay sınıfı → olay paketi zinciriyle bağlanmış bir paket seçilene kadar doldurulmaz. Aynı anda tek kanonik paket; gösterge paneli toplaması değildir.",
  ...
  accessSubmit: "Devam",
  accessBack: "Geri",
  accessNote: "Bu yüzey kasıtlı olarak sınırlıdır. Erişim yalnızca yetkili kurumsal kapsamla açılır.",
  ...
  docFamily_passWitnessSummary: "PASS Tanık Özeti",
  docFamily_passVerificationSummary: "PASS Doğrulama Özeti",
  docFamily_passIncidentReviewSummary: "PASS Olay İnceleme Özeti",
  docFamily_passLimitationAnnex: "PASS Sınırlama Eki",
  docFamily_passVehicleIncidentReport: "PASS Araç Olay Raporu",
  docFamily_integrityFailureNotice: "Bütünlük İhlali Bildirimi",
  docFamily_tamperDetectedNotice: "Kurcalama Tespit Bildirimi",
  docFamily_chainBreachNotice: "Zincir Kırılması Bildirimi",
  docFamily_artifactInvalidityNotice: "Artefakt Geçersizlik Bildirimi",
